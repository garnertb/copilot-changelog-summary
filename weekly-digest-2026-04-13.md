...
- Data residency US/EU + FedRAMP (Apr 13): 10% model multiplier premium, all GA features supported
- Merge conflict fix in 3 clicks (Apr 13): cloud agent @copilot PR button
- Rate limits + Opus 4.6 Fast retired (Apr 10): new service/model limits for Copilot Pro
- Copilot Pro trials paused (Apr 10): anti-abuse measure, existing unaffected
- Cloud agent usage metrics (Apr 10): daily/weekly/monthly counts in dashboards
- CLI activity in metrics totals (Apr 10): CLI now in top-level totals + feature breakdowns
- GitHub Code Quality standard findings improvements (Apr 14): Copilot Autofix, file search, bulk dismiss
- Model selection for Claude and Codex agents (Apr 14): choose Anthropic/OpenAI models for cloud agents
