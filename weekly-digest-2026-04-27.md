...
- **GitHub App token format change** (Apr 24) — New ghs_APPID_JWT format ~520 chars; staged rollout.
- **Copilot cloud agent usage metrics API** (Apr 23) — used_copilot_cloud_agent field; old field deprecated Aug 1 2026.
- **Copilot cloud agent 20% faster startup** (Apr 27) — Prebuilt Actions custom images.
- **Copilot code review: Actions minutes billing June 1, 2026** (Apr 27) — MAJOR: private repo reviews consume Actions minutes starting June 1.
- **Copilot Student: GPT-5.3-Codex removed from model picker** (Apr 27) — Still via auto model selection.
